...
const BirthdayGuardianSpawnerDefinition = {
    angle: Math.PI,
    offset: 0,
    size: 130,
    width: 71.4,
...
const BirthdayGuardianSpawnerDefinition2 = {
    angle: Math.PI,
    offset: 0,
    size: 100,
    width: 109.2,
...
class Guardian extends AbstractBoss_1.default {
    constructor(game) {
        ...
        this.barrels.push(new Barrel_1.default(this, BirthdayGuardianSpawnerDefinition));
        this.barrels.push(new Barrel_1.default(this, BirthdayGuardianSpawnerDefinition2));
    }
    get sizeFactor() {
